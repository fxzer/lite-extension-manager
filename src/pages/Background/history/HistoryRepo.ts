import Dexie, { Dexie as DexieClass } from "dexie"
...
class HistoryRepoClass extends DexieClass {
  history!: Dexie.Table<Partial<HistoryRecord>, number>
...
// 导出单例
const instance = new HistoryRepoClass()
export const HistoryRepo = instance
